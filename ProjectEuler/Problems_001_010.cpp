...
int CalculateTheSumOfMultipliesThatAreLessThan(int multiplyElement, int upperBound)
{
	...
	// S_n = ((2*a_1 + (n-1)*r)/2)*n
	int sumOfMultiplies = ((2 * firstElement + (lastElementIndex - 1) * difference) / 2)*lastElementIndex;
...
void Problem_003(void)
{
	...
	std::list<long long> listOfPrimeFactors;
...
void Problem_008(void)
{
	...
	{
		// change to pass the iterators to function instead of creating (with copy) new vector
